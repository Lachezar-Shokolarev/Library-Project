...
namespace LibraryWeb.Controllers
{
    public class TitlesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TitleId,Name,Description,Author,Year,ISBN,Type,MainImage,Publisher,PublisherYear")] Title title)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TitleId,Name,Description,Author,Year,ISBN,Type,MainImage,Publisher,PublisherYear")] Title title)
        {
            if (id != title.TitleId)
            {
                return NotFound();
